<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<!-- --------------------------------- -->  
<div class='modal' id='reviewModal' style='width:70%;margin:auto'>
...
<form method="post" enctype="multipart/form-data" name="rf2" id="rf2">
	...
	<tr>
		...
		<td>
		<!-- 파일 업로드가 없는 일반적인 폼 데이터를 전송할 때 => send()함수통해 ajax요청-->
		<!-- <a type="button" class="btn btn-success"
				onclick="send()">글쓰기</a> -->
				
		<!-- default submit button -->		
		<button class="btn btn-outline-success">글 수정</button>
